...
1. Вы должны указать этот сайт, чтобы другие, увидев ваш перевод, могли сделать другой свой, например: 'Сделано благодаря 'ССЫЛКА'', или по лубому другому способу.
2. Вам нужно упомянуть '@Yarondorik' рядом с ссылкой на этот сайт, чтобы другие могли знать, к кому, если что, обращаться.
